...
public class activity_toplama extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final MediaPlayer mediaPlayer = MediaPlayer.create(activity_toplama.this, R.raw.dogru);
    ...
    public void setQuestion(){
        ...
        if (index>10 && sayac==10 ){
            ...
            Intent intent=new Intent(activity_toplama.this,MainActivity.class);
