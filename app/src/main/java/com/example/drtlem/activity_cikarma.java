...
public class activity_cikarma extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cikarma=intent.getIntExtra("cikarma",1);
        final MediaPlayer mediaPlayer = MediaPlayer.create(activity_cikarma.this, R.raw.dogru);
    ...
    public void setQuestion(){
        ...
        if (index>10 && sayac==10 ){
            ...
            Intent intent=new Intent(activity_cikarma.this,MainActivity.class);
