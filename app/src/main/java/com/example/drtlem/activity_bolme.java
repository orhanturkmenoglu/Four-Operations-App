...
public class activity_bolme extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bolme=intent.getIntExtra("bolme",1);
        final MediaPlayer mediaPlayer = MediaPlayer.create(activity_bolme.this, R.raw.dogru);
    ...
    public void setQuestion(){
        ...
        if (index>10 && sayac==10 ){
            ...
            Intent intent=new Intent(activity_bolme.this,MainActivity.class);
